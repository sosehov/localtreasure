...
// Define custom prop types for DayButton to support onDayClick
...
// Custom DayButton with support for onDayClick and outside styling
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        {
          "text-muted-foreground opacity-60": modifiers.outside,
        },
