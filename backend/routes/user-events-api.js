...
router.post("/createEvent", async (req, res) => {
  ...
  try {
    await eventsQueries.createUserEvent({
      user_id,
      title,
      description,
      date,
...
router.post("/updateEvent", authenticateUser, async (req, res) => {
  const {
    event_id,
    title,
    description,
  ...
  try {
    await eventsQueries.updateUserEvent({
      event_id,
      user_id,
      title,
      description,
